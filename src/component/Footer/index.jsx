    ...
    <>
      <div className="footer">
        <div className="footerContainer">
          <div className="footerLogo">Bewakoof</div>
          <div className="footerContent">
            ...
            <div className="footerBox">
              ...
              <div className="footerLink">We're Hiring</div>
            ...
            <div className="footerBox">
              ...
              <div className="footerLink">4.7M People Like this</div>
              <div className="footerLink">1M Followers </div>
              <div className="footerLink">Terms & Conditions</div>
            </div>
            <div className="footerBox">
              <div className="footerHeader">KEEP UP TO DATE</div>
      ...
      >
        <div className="footerMiddle">
          <div className="footerMiddleContent">
            <div className="footerMiddleHeader">MEN'S CLOTHING</div>
            <div className="footerLink">Top Wear</div>
            <div className="footerLink">Men's New Arrival</div>
            <div className="footerLink">Men's Half Sleeve T-shirt</div>
            <div className="footerLink">Men's Hoodies & Sweatshirts</div>
            <div className="footerLink">Men's Long Sleeve T-shirts</div>
            <div className="footerLink">Men's Printed T-shirts</div>
            <div className="footerLink">Men's Plain T-shirts</div>
            <div className="footerLink">TMen's New Arrival</div>
            <div className="footerLink">Men's Vests</div>
            <div className="footerLink">Men's Polo T-Shirts</div>
            <div className="footerLink">Men's Kurtas</div>
            <div className="footerLink">Men's Combo T-Shirts</div>
            <div className="footerLink">Men's Shirts</div>
            <div className="footerLink">Men's Nightwear</div>
            <div className="footerLink">Men's Plus Size Store</div>
            <div className="footerLink" style={{ marginTop: "10px" }}>
              Bottom Wear
            </div>
            <div className="footerLink">Men's Pajamas</div>
            <div className="footerLink">Men's Boxer Shorts</div>
            <div className="footerLink">Men's Shorts</div>
            <div className="footerLink">Men's Track Pants</div>
            <div className="footerLink">Men's Pants</div>
            <div className="footerLink" style={{ marginTop: "10px" }}>
              Featured
            </div>
            <div className="footerLink">Men's Flip Flops</div>
            <div className="footerLink">Men's Sliders</div>
            <div className="footerLink">Marvel T-Shirts</div>
            <div className="footerLink">Disney T-Shirts</div>
            <div className="footerLink">Avengers T-Shirts</div>
            <div className="footerLink">Star Wars T-Shirts</div>
            <div className="footerLink">Batman T-Shirts</div>
            <div className="footerLink">Superman T-Shirts</div>
            <div className="footerLink">Joker T-Shirts</div>
          </div>
          <div className="footerMiddleContent">
            <div className="footerMiddleHeader">WOMEN'S CLOTHING</div>
            <div className="footerLink">Women's Top Wear</div>
            <div className="footerLink">Women's New Arrivals</div>
            <div className="footerLink">Women's T-Shirts</div>
            <div className="footerLink">Women's Hoodies & Sweatshirts</div>
            <div className="footerLink">Women's Dresses</div>
            <div className="footerLink">Women's 3/4 Sleeve T-Shirts</div>
            <div className="footerLink">Women's Kurtis</div>
            <div className="footerLink">Women's Combo T-Shirts</div>
            <div className="footerLink">Women's Nightwear</div>
            <div className="footerLink">Women's Plus Size Store</div>
            <div className="footerLink" style={{ marginTop: "10px" }}>
              Women's Bottom Wear
            </div>
            <div className="footerLink">Women's Pajamas</div>
            <div className="footerLink">Women's Boxer Shorts</div>
            <div className="footerLink">Women's Jeans</div>
            <div className="footerLink">Women's Joggers</div>
            <div className="footerLink">Women's Shorts</div>
            <div className="footerLink" style={{ marginTop: "10px" }}>
              BAGS
            </div>
            <div className="footerLink">Laptop Bags</div>
            <div className="footerLink">Small Backpacks</div>
            <div className="footerLink" style={{ marginTop: "10px" }}>
              Featured
            </div>
            <div className="footerLink">Women's Slides</div>
            <div className="footerLink">Women's Flip Flops</div>
          </div>
          <div className="footerMiddleContent">
            <div className="footerMiddleHeader">MOBILE COVERS</div>
            <div className="footerLink">Brands</div>
            <div className="footerLink">Apple</div>
            <div className="footerLink">Realme</div>
            <div className="footerLink">Smasung</div>
            <div className="footerLink">Xiomi</div>
            <div className="footerLink">Oneplus</div>
            <div className="footerLink">Vivo</div>
            <div className="footerLink">Oppo</div>
          </div>
          <div className="footerMiddleContent">
            <div className="footerMiddleHeader" style={{ color: "skyblue" }}>
              FANBOOK
            </div>
            <div className="footerMiddleHeader" style={{ color: "skyblue" }}>
              OFFERS
      ...
      <div className="footerStories">
        <div className="footerStoriesContent">
          <div className="footerStoriesHeader">
            BEWAKOOF® THE NEW AGE ONLINE SHOPPING EXPERIENCE.
          </div>
          <div className="footerStoriesText">
          ...
          <div className="footerStoriesHeader">OUR PHILOSOPHY</div>
          <div className="footerStoriesText" style={{ marginBottom: "100px" }}>
